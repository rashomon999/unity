...
public class Secuencia_Tres : MonoBehaviour
{
    public TMP_InputField input1,input2; // Referencias a los inputs de TextMeshPro
    ...
    public string respuestaCorrecta2 = "Respuesta2"; // Respuestas correctas 
