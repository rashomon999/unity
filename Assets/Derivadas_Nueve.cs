...
public class Derivadas_Nueve : MonoBehaviour
{
    public TMP_InputField input1, input2, input3, input4, input5, input6, input7, input8, input9, input10; // Referencias a los inputs de TextMeshPro
     ...
     public void Verificar()
    {
        ...
        if (input10.text != respuestaCorrecta10) esCorrecto = false;
